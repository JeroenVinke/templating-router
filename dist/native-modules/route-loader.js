...
export var TemplatingRouteLoader = (_dec2 = inject(CompositionEngine), _dec2(_class2 = function (_RouteLoader) {
  ...
  TemplatingRouteLoader.prototype.loadRoute = function loadRoute(router, config) {
    ...
    var viewModel = config.moduleId === null ? EmptyClass : /\.html/i.test(config.moduleId) ? createDynamicClass(config.moduleId) : relativeToFile(config.moduleId, Origin.get(router.container.viewModel.constructor).moduleId);
